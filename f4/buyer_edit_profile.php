...
<div class="container rounded mt-5 mb-5">
    <form method="post" action="buyer_edit_profile2.php"  enctype="multipart/form-data">
    <div class="row">
        ...
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                        <button class="btn btn-primary profile-button" value="Upload" type="submit"><b>Save Profile</b></button>
                    </div>
                    </form>
                    <div class="col-md-6">
