...
<div class="container rounded mt-5 mb-5">
        ...
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-6"><label class="labels"><b>Seller Name</b></label>
                    <p><?php echo $seller_name; ?></p></div>
                </div>
                <div class="row mt-3">
                    <div class="col-md-12"><label class="labels"><b>Mobile Number</b></label>
                        <p><?php echo $phone; ?></p></div>
                    <div class="col-md-12"><label class="labels"><b>Email</b></label>
                        <p><?php echo $email; ?></p></div>
                    <div class="col-md-12"><label class="labels"><b>Address</b></label>
 ...
 <script>
function goBack() {
  window.location.href ="seller_logged-in.php";
}
</script>

<script>
    function myfunc() {
      window.location.href ="seller_edit_profile.php";
    }
</script> 